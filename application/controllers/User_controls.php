        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->input->get("user_id") != NULL) {
                    ...
                    <style>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-sm-offset-2 col-md-offset-2">
                                ...
                                <br /><br />
                                <div class="pm-button text-center"><a href="https://www.payumoney.com/paybypayumoney/#/116435"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/212.png" /></a></div>
                                <br /><br />
                                <div class="pm-button text-center">
                                    <a class = "btn btn-bg btn-md btn-success " href = "<?= base_url('convert_pdf?user_id=' . $this->input->get('user_id')) ?>" >Download Registration Receipt</a>
                                </div>
                                <br />
                                <div class="text-center">
                                    <b><font color='red'>Note:</font> You must bring both registration receipt and <br />payment receipt (That you receive from 
                ...
                <div class="col-sm-6 col-md-6 col-sm-offset-2 col-md-offset-2">
                    ...
                    <br /><br />
                    <div class="pm-button text-center"><a class="" href="https://www.payumoney.com/paybypayumoney/#/B768B5B1DA942E2106287E0360C621A3"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/212.png" /></a></div>
                    <br /><br />
                    <div class="pm-button text-center">
                        <a class = "btn btn-bg btn-md btn-success " href = "<?= base_url('convert_pdf?user_id=' . $this->input->get('user_id')) ?>" >Download Registration Receipt</a>
                    </div>
