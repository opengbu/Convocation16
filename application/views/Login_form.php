...
<html>
    <head>
        <title>Login to GBU Convocation | 2016</title>
                ...
                <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><div class="text-center"> Sign in to GBU Convocation 2016</div></h3>
                        </div>
                        <div class="panel-body">
                            <center>
                                <img width="50%" src ="<?php echo base_url() . '/application/views/common/' . 'logo.png' ?>" >
                            </center>
                            ...
                            <a class="btn btn-success btn-lg btn-block" href="<?= base_url('register/get_roll_no') ?>" >Not Registered Yet? Sign Up!</a>
                            <br />
